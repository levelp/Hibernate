...
public class HibernatePostgresTest extends Assert {
    ...
    public void testGetConnectionProperties() {
        String database = getPersistenceProperty("jakarta.persistence.jdbc.url");
        String dbUser = getPersistenceProperty("jakarta.persistence.jdbc.user");
        // Невозможно получить пароль в явном виде
        String dbPassword = getPersistenceProperty("jakarta.persistence.jdbc.password");
